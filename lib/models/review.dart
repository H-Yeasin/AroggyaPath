...
List<Review> reviews = [
  Review(
    ...
    rate: 4.6,
    comment: "Many thanks to my doctor! She is professional, expert and competent doctor...",
    date: "10/22/2022",
    color: 0xFFffcdcf,
  ),
  Review(
  ...
  Review(
    ...
    rate: 4.5,
    comment: "The doctor was incredibly attentive and really took the time to listen to my concerns. I felt like my health and well-being truly mattered. Highly recommend!",
    date: "12/10/2022",
    color: 0xFFf9d8b9,
  ),
  Review(
    ...
    rate: 3.5,
    comment: "I was nervous before my appointment, but the doctor's calm and reassuring manner put me right at ease. I left with a clear understanding of my treatment plan.",
    date: "4/19/2022",
    color: 0xFFccae4d,
  ),
  Review(
    ...
    rate: 3.3,
    comment: "Amazing experience! The doctor was thorough and answered all my questions without rushing. I feel much more confident about my health.",
    date: "10/27/2022",
    color: 0xFF086887,
  ),
  Review(
    ...
    image: "https://png.pngtree.com/thumb_back/fh260/background/20230614/pngtree-woman-in-sunglasses-standing-in-front-of-a-dark-background-image_2891237.jpg",
    rate: 3.9,
    comment: "The level of care I received was outstanding! I appreciated how the doctor explained everything in detail, making sure I understood my options.",
    date: "10/11/2022",
    color: 0xFFe1edf8,
  ),
  Review(
  ...
  Review(
    ...
    rate: 3.7,
    comment: "The doctor was very professional and empathetic. I felt heard and understood, and the treatment has already made a difference.",
    date: "5/11/2022",
    color: 0xFFe1edf8,
  ),
];
